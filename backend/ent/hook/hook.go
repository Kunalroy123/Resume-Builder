...
// The HeaderContactInfoFunc type is an adapter to allow the use of ordinary
// function as HeaderContactInfo mutator.
type HeaderContactInfoFunc func(context.Context, *ent.HeaderContactInfoMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f HeaderContactInfoFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.HeaderContactInfoMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.HeaderContactInfoMutation", m)
}
...
// The ProfessionalSummaryFunc type is an adapter to allow the use of ordinary
// function as ProfessionalSummary mutator.
type ProfessionalSummaryFunc func(context.Context, *ent.ProfessionalSummaryMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProfessionalSummaryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProfessionalSummaryMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProfessionalSummaryMutation", m)
}
