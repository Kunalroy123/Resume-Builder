...
func (_q *UserQuery) QueryResumes() *ResumeQuery {
...
func (_q *UserQuery) WithResumes(opts ...func(*ResumeQuery)) *UserQuery {
	query := (&ResumeClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadResumes(ctx context.Context, query *ResumeQuery, nodes []*User, init func(*User), assign func(*User, *Resume)) error {
